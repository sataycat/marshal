  ...
  return (
    <section className="flex min-h-0 min-w-0 flex-1 flex-col border-b border-border bg-bg md:border-r md:border-b-0 md:basis-[46%]">
      <header className="flex items-center gap-2 border-b border-border bg-panel px-3 py-2">
        ...
        <div className="min-w-0 flex-1"><h2 className="text-sm font-semibold">Scratch draft</h2><p className="text-[0.68rem] text-muted">Markdown authoring buffer</p></div>
      ...
      <p className="border-t border-border px-3 py-2 text-right text-[0.68rem] text-muted">Cmd/Ctrl+Enter to send, Shift+Enter for a new line</p>
    </section>
  );
}
